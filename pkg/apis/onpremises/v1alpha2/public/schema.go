...
type SpecKubernetesAdvanced struct {
	...
	// Configures the EventRateLimit plugin limits for the API Server. Each item
...
type SpecKubernetesAdvancedControllerManager struct {
	// Maximum number of terminated pods kept by the controller-manager before
	// automatic deletion.
...
type SpecKubernetesAdvancedEventRateLimitsElem struct {
	...
	// Maximum number of objects in cache for this bucket. Only for certain types like
	// Namespace or User.
