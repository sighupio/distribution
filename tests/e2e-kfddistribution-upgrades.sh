...
echo "----------------------------------------------------------------------------"
echo "Executing furyctl for the initial setup 1.29.6"
/tmp/furyctl apply --config tests/e2e/kfddistribution-upgrades/furyctl-init-cluster-1.29.6.yaml --outdir "$PWD" --disable-analytics
