...
# v1.33.2 base config: the cluster we install, then upgrade. calico + gatekeeper
...
# v1.33.3 upgrade target: identical to the base config but the newer version and
