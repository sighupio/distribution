...
# Storage Directories Tests (100-110)

@test "100 - ok" {
    info

    test_schema "public" "immutable-kfd-v1alpha2" "100-ok" expect_ok
}

@test "101 - ok" {
    info

    test_schema "public" "immutable-kfd-v1alpha2" "101-ok" expect_ok
}

@test "102 - ok" {
    info

    test_schema "public" "immutable-kfd-v1alpha2" "102-ok" expect_ok
}

@test "103 - no" {
    info

    test_schema "public" "immutable-kfd-v1alpha2" "103-no" expect_no
}

@test "104 - no" {
    info

    test_schema "public" "immutable-kfd-v1alpha2" "104-no" expect_no
}

@test "105 - no" {
    info

    test_schema "public" "immutable-kfd-v1alpha2" "105-no" expect_no
}

@test "106 - no" {
    info

    test_schema "public" "immutable-kfd-v1alpha2" "106-no" expect_no
}

@test "107 - no" {
    info

    test_schema "public" "immutable-kfd-v1alpha2" "107-no" expect_no
}

@test "108 - no" {
    info

    test_schema "public" "immutable-kfd-v1alpha2" "108-no" expect_no
}

@test "109 - no" {
    info

    test_schema "public" "immutable-kfd-v1alpha2" "109-no" expect_no
}
