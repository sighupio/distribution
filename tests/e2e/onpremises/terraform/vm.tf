...
variable "server_type" {
  type = string
  # Full distribution (cilium, opensearch, mimir, velero, ...) across 7 container
  # nodes is RAM/disk heavy: use a large dedicated instance.
  default = "ccx43" # 16 vCPU / 64 GB / 360 GB disk
}
