...
$kappbin deploy -a kfd -n kube-system -f out.yaml $additionalKappArgs --allow-all-ns -y --default-label-scoping-rules=false --apply-default-update-strategy=fallback-on-replace -c --wait-timeout 60m0s --apply-timeout 60m0s --apply-concurrency 20
