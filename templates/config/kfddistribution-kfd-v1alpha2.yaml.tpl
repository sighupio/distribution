# yaml-language-server: $schema=https://raw.githubusercontent.com/sighupio/distribution/{{.DistributionVersion}}/schemas/public/kfddistribution-kfd-v1alpha2.json
...
# https://docs.kubernetesfury.com/docs/installation/sd-configuration/providers/KFDDistribution
