...
### Installer Updates
- [on-premises](https://github.com/sighupio/installer-on-premises) 📦 installer: [**v1.34.4**](https://github.com/sighupio/installer-on-premises/releases/tag/v1.34.4)
...
- [eks](https://github.com/sighupio/installer-eks) 📦 installer: [**v3.4.0**](https://github.com/sighupio/installer-eks/releases/tag/v3.4.0)
...
### Module updates
- [networking](https://github.com/sighupio/module-networking) 📦 core module: [**v3.1.0**](https://github.com/sighupio/module-networking/releases/tag/v3.1.0)
...
- [ingress](https://github.com/sighupio/module-ingress) 📦 core module: [**v5.0.0**](https://github.com/sighupio/module-ingress/releases/tag/v5.0.0)
...
- [monitoring](https://github.com/sighupio/module-monitoring) 📦 core module: [**v4.1.0**](https://github.com/sighupio/module-monitoring/releases/tag/v4.1.0)
  - This release adds the support to Kubernetes 1.34 and updates MinIO.
- [tracing](https://github.com/sighupio/module-tracing) 📦 core module: [**v1.4.0**](https://github.com/sighupio/module-tracing/releases/tag/v1.4.0)
  - This release adds the support to Kubernetes 1.34 and updates MinIO.
- [dr](https://github.com/sighupio/module-dr) 📦 core module: [**v3.3.0**](https://github.com/sighupio/module-dr/releases/tag/v3.3.0)
  - This release updates Velero to v1.17.1, the Velero plugins to v1.13.1 and the Snapshot Controller to v8.4.0 .
- [logging](https://github.com/sighupio/module-logging) 📦 core module: [**v5.3.0**](https://github.com/sighupio/module-logging/releases/tag/v5.3.0)
  - This release adds the support to Kubernetes 1.34 and updates MinIO.
- [policy](https://github.com/sighupio/module-policy) 📦 core module: [**v1.16.0**](https://github.com/sighupio/module-policy/releases/tag/v1.16.0)
  - This release updates Kyverno to version 1.16.0 and Gatekeeper to version 3.21.0.
- [auth](https://github.com/sighupio/module-auth) 📦 core module: [**v0.6.1**](https://github.com/sighupio/module-auth/releases/tag/v0.6.1)
...
Follow the [migration guide from NGINX to HAProxy KIC](https://docs.sighup.io/docs/advanced-use-cases/nginx-to-haproxy-migration) for a smooth transition.
