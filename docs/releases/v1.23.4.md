# SIGHUP Distribution Release v1.23.4

Welcome to SKD release `v1.23.4`.
...
- [networking](https://github.com/sighupio/fury-kubernetes-networking) 📦 core module: v1.10.0 -> [**v1.12.2**](https://github.com/sighupio/fury-kubernetes-networking/releases/tag/v1.12.1)
...
- Logging
  ...
  - Added a new index for infrastructural (SKD's) components and left the `kubernetes` index for applications specific logs.
