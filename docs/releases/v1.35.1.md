...
Welcome to the latest release of SD maintained by SIGHUP by ReeVo team. This is a patch release including some general bug fixes and improvements to the (recently introduced) Immutable kind. There are no version bumps except for Prometheus in Agent mode.
