...
- [immutable](https://github.com/sighupio/installer-immutable) 📦 installer: [**v1.35.5-rev.1**](https://github.com/sighupio/installer-immutable/releases/tag/v1.35.5-rev.1)
