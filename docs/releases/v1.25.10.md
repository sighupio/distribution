# SIGHUP Distribution Release v1.25.10

Welcome to SKD release `v1.25.10`.
...
- Enhancement: improved and added new end-to-end tests to cover migrations using the SKDDistribution kind.
