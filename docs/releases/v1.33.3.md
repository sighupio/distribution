# SIGHUP Distribution Release v1.33.3

Welcome to SD release `v1.33.3`.

The distribution is maintained with ❤️ by the team [SIGHUP by ReeVo](https://sighup.io/).

This patch release backports the `v1.35.0` and `v1.35.1` module updates and features to the `v1.33` line, while keeping **Kubernetes 1.33** as the supported minor version. It targets Kubernetes `v1.33.12` on-premises (bumped from `1.33.7` in `v1.33.2`) and continues to support EKS `1.33`.
...
- [on-premises](https://github.com/sighupio/installer-on-premises) 📦 installer: [**v1.35.5**](https://github.com/sighupio/installer-on-premises/releases/tag/v1.35.5)
  - Installs Kubernetes version 1.33.12 and adds support for Kubernetes v1.34.8.
...
- [eks](https://github.com/sighupio/installer-eks) 📦 installer: [**v3.5.0**](https://github.com/sighupio/installer-eks/releases/tag/v3.5.0)
  - Verified compatibility with Kubernetes 1.33.
